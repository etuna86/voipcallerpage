<?php
    ...
    $show_more_button  = $buttons_counter > 4 ? true : false;
                        ...
                        <?php if ($show_more_button) { ?>
                            ...
                            <?php } else {
                                if(!empty($row->action_urls)){
                                    foreach($row->action_urls as $action_unique_id => $action_url){
                                        $action = $actions[$action_unique_id];
                                        if (strpos($action_url, '/delete/') !== false) {
                                               ?>
                                            <a data-target="<?php echo $action_url; ?>" href="javascript:void(0)" class="text-danger-important delete-row btn btn-default">
                                                <i class="text-danger fa <?php echo $action->css_class; ?>"></i> <?php echo $action->label?>
                                            </a>
                                            <?php
                                        }else{
                                            ?>
