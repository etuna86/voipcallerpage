 		...
 		<div class="row">
        	<div class="table-section">
                <div class="table-label">
                    ...
                    <div class="floatR r5 minimize-maximize-container minimize-maximize hidden" >
                        <i class="fa fa-caret-up"></i>
                    </div>
                    <div class="floatR r5 gc-full-width hidden" >
                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        ...
                        <div class="header-tools">
                            ...
                            <?php if(isset($this->add_refresh_btn) && $this->add_refresh_btn == 1){
                                ?>
...
<!--                                            </a>-->
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <td>
                                            <input type="text" class="form-control searchable-input floatL" placeholder="<?php print lang('') ?> <?php echo $column->display_as; ?>" name="<?php echo $column->field_name; ?>" />
                                        </td>
                                    <?php }?>
        						</tr>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li>
                                                            <a href="javascript:void(0)" class="clear-filtering">
                                                                <i class="fa fa-eraser"></i> <?php print lang('clearfiltering'); ?>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
